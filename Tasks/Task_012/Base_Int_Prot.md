...
```
ip dhcp excluded-address 192.168.11.1 192.168.11.126
ip dhcp excluded-address 192.168.12.1 192.168.12.126
...
SW5:
```
ip dhcp excluded-address 192.168.11.127 192.168.11.254
ip dhcp excluded-address 192.168.12.127 192.168.12.254
