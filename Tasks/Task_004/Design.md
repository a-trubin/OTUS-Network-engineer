...
2) Протокол LACP/PAgP отказался работать в развернутой виртуальной среде, повторил конфигурацию в CPT - заработало. Скорее всего баг (почитав форумы, выяснил, что данная ошибка не редкость).  
3) Адресация была настроена на всех устройствах. В репозитории лежат конфигурационные файлы основых устройств, где проводились иные настройки.
